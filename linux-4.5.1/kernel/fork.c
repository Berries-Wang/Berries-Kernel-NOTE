 ...
 *
 * It copies the registers, and all the appropriate(恰当的)
 * parts of the process environment (as per the clone
 * flags). The actual kick-of(删除、分离) is left to the caller.
 */
					...
					unsigned long tls)
{
	...
	/**
	 * security_task_create: 定义于include/linux/security.h中,属于Linux Security Module这一模块,通过在Linux内核代码中
